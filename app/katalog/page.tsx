...
const normalizedCat = filterCat?.toLowerCase().trim();
if (filterCat && filterCat.toLowerCase() !== 'semua') {
  supabaseQuery = supabaseQuery.ilike('category', `%${filterCat}%`);
}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-10 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="leading-none">
              ...
              <span className="text-[10px] font-bold text-[#1B4332] uppercase tracking-widest">Kejari Takalar</span>
            </div>
          </div>
