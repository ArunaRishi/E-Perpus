    ...
    <div className="min-h-screen bg-[#F0F2F5] font-sans selection:bg-emerald-200">
      ...
      <style>{`
        ...
        .card-hover:hover {
          ...
          box-shadow: 0 24px 48px -12px rgba(63, 60, 25, 0.18);
        }
        ...
        <div className="max-w-7xl mx-auto px-6 h-[72px] flex items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3.5 shrink-0">
            ...
            <div className="leading-none">
              ...
              <p className="text-[10px] font-semibold text-emerald-600 tracking-widest uppercase mt-0.5">Kejaksaan Negeri Takalar</p>
            </div>
          </div>
      ...
      {/* HERO                                               */}
      {/* ─────────────────────────────────────────────────── */}
      <header className="relative bg-[#000] overflow-hidden pt-24 pb-36">
        {/* Layered background */}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="anim-up-3 text-emerald-100/70 font-medium max-w-xl text-[15px] leading-relaxed mb-10">
              Akses cepat & transparan ke ratusan literatur hukum, aset, dan dokumen referensi milik Kejaksaan Negeri Takalar — tersedia untuk publik dan internal.
            </p>
      ...
      <footer className="bg-[#0a1f12] text-slate-400">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-white font-bold text-[13px]">E-Perpustakaan Kejaksaan Negeri Takalar </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-[12px]">
              ...
              <li><a  href="https://kejari-takalar.kejaksaan.go.id/"          className="hover:text-emerald-400 transition-colors flex items-center gap-2"><span className="text-emerald-700">›</span> Situs Resmi Instansi</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/5 py-6 text-center text-[10px] text-slate-600 uppercase tracking-widest font-medium">
          &copy; {new Date().getFullYear()} Kejaksaan Negeri Takalar · Kejaksaan RI · Hak Cipta Dilindungi
        </div>
      </footer>
