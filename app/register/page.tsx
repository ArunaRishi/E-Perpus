      ...
      <div className="hidden lg:flex lg:w-[45%] bg-[#0f2a1c] relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-emerald-400 text-[10px] font-semibold uppercase tracking-widest mt-0.5">Kejaksaan Negeri Takalar</p>
          </div>
        </div>
        ...
        <div className="relative z-10">
          ...
          <p className="text-emerald-100/60 text-[14px] leading-relaxed max-w-xs font-medium">
            Daftarkan akun Anda sebagai pegawai Kejaksaan Negeri Takalar untuk mengakses fitur peminjaman digital.
          </p>
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-10 anim-up">
            ...
            <div>
              ...
              <p className="text-emerald-600 text-[10px] font-semibold uppercase tracking-widest">Kejaksaan Negeri Takalar</p>
            </div>
          </div>
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div className="anim-up-d2">
                ...
                <input
                  ...
                  placeholder="nama@kntakalar.com"
                  value={email}
